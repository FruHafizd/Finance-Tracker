            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1 flex items-center gap-1.5">
                        ...
                        {{ $this->isEditing() ? 'Perbarui informasi catatan keuangan' : 'Kelola arus kas Anda' }}
                    </p>
                </div>
                <button
            ...
            <div class="space-y-2">
                ...
                <div class="relative flex p-1 bg-gray-100/80 rounded-2xl">
                    <button
                        ...
                        <svg class="w-5 h-5 {{ $type === 'income' ? 'text-emerald-500' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                        ...
                        <svg class="w-5 h-5 {{ $type === 'expense' ? 'text-rose-500' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
