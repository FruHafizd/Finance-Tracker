<x-modal name="modal-create" focusable>
    <div class="max-h-[92vh] overflow-y-auto">
        ...
        <div class="sticky top-0 z-10 bg-white border-b border-gray-100 px-5 py-4 sm:px-7 sm:py-5">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div>
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900 leading-tight">Tambah Catatan Keuangan</h2>
                        <p class="text-xs text-gray-400 mt-0.5">Isi formulir di bawah untuk menambah catatan</p>
                    </div>
                </div>
                <button
        ...
        <!-- FORM BODY -->
        <form wire:submit.prevent="save" class="px-5 py-5 sm:px-7 sm:py-6 space-y-5">
