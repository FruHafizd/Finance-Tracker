    ...
    <form wire:submit="register" class="space-y-6">
        ...
        <div class="pt-2">
            <button type="submit" 
                    ...
                    class="w-full flex items-center justify-center py-4 bg-slate-900 text-white rounded-2xl font-bold text-base hover:bg-slate-800 transition-all duration-200 active:scale-95 shadow-lg shadow-slate-200 disabled:opacity-70 disabled:cursor-not-allowed">
